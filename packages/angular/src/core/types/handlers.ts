...
export type UserHandlers<T extends AnyHandlerEventTypes = EventTypes> = {
  ...
  onPullToRefresh: Handler<'pullToRefresh', check<T, 'pullToRefresh'>>;
  onPullToRefreshStart: Handler<'pullToRefresh', check<T, 'pullToRefresh'>>;
  onPullToRefreshEnd: Handler<'pullToRefresh', check<T, 'pullToRefresh'>>;
};
