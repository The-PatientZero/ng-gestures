...
import { PullToRefreshEngine } from './engines/PullToRefreshEngine';
import { pullToRefreshConfigResolver } from './config/pullToRefreshConfigResolver';
...
export const pullToRefreshAction: Action = {
  key: 'pullToRefresh',
  engine: PullToRefreshEngine as any,
  resolver: pullToRefreshConfigResolver
};
